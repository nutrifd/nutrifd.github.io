  ...
  <tr><th>Name</th><th>Value</th></tr>
    ...
    drawCenterTexts() {
        ...
        fo.patternify({ tag: "xhtml:div", selector: "for-center-div" })
            .html(`<div style="height:${calc.innerRadius * 2
...
export function NotSoSimplePieChart(props) {
    const ref = useRef();
    const { height, data, title } = props;
    ...
    useEffect(() => {
        new PieChart().data(data).svgHeight(height).container(ref.current).centerText(title).render();
        return;
    }, [dimensions]);
    return (
        <>
